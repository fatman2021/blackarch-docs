%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                              %
% BlackArch Linux document template                                            %
%                                                                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{color}
\usepackage[%
pdftitle={BlackArch Linux, <title here>},
pdfsubject={BlackArch Linux, <subject here>},
...
\end{figure}
\vspace{2cm}
\Huge{\textbf{Add a nice title here}}\\
\vspace{1cm}
\Huge{Subtitle / Author Name / Whatever}\\
\vspace{0.5cm}
\LARGE{\today}
\end{center}
\newpage
